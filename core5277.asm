...
;---TIMER-STRUCTURE---------------------------------------(5b);
	.EQU	_CORE5277_TIMER_STRUCT_SIZE		= 0x05			;Длина блока таймера
	...
	.EQU	_CORE5277_TIMER_DEFAULT				= 0x04			;1b - порог 0x01-0x7f, 7-бит:период отсчета,H:0.002s,L:0.00005s)
...
.IF TIMERS > 0x00
	LDI YH,high(_CORE5277_TIMERS)
	LDI YL,low(_CORE5277_TIMERS)
	LDI LOOP_CNTR,TIMERS
_CORE5277_TIMER_A_IR__HF_LOOP:
	LDD PID,Y+_CORE5277_TIMER_PROC_ID
	CPI PID,0xff
	BREQ _CORE5277_TIMER_A_IR__HF_NEXT
	LDD ACCUM,Y+_CORE5277_TIMER_DEFAULT
	SBRC ACCUM,0x07
	RJMP _CORE5277_TIMER_A_IR__HF_NEXT
	LDD TEMP,Y+_CORE5277_TIMER_CNTR
	DEC TEMP
	BRNE PC+0x09
	LDD ZH,Y+_CORE5277_TIMER_HANDLER+0x00
	LDD ZL,Y+_CORE5277_TIMER_HANDLER+0x01
	ICALL
	MOV TEMP,ACCUM
	ANDI TEMP,0x7f
	STD Y+_CORE5277_TIMER_CNTR,TEMP
_CORE5277_TIMER_A_IR__HF_NEXT:
	ADIW YL,0x05
	DEC LOOP_CNTR
	BRNE _CORE5277_TIMER_A_IR__HF_LOOP
.ENDIF
_CORE5277_TIMER_IR__DISPATCHER:
	...
	BRNE _CORE5277_TIMER_A_IR__END								;1/2 + 1
...
.IF TIMERS > 0x00
	...
	LDI YL,low(_CORE5277_TIMERS)
	LDI LOOP_CNTR,TIMERS
_CORE5277_TIMER_A_IR__LF_LOOP:
	LDD PID,Y+_CORE5277_TIMER_PROC_ID
	CPI PID,0xff
	BREQ _CORE5277_TIMER_A_IR__LF_NEXT
	LDD ACCUM,Y+_CORE5277_TIMER_DEFAULT
	SBRS ACCUM,0x07
	RJMP _CORE5277_TIMER_A_IR__LF_NEXT
	LDD TEMP,Y+_CORE5277_TIMER_CNTR
	DEC TEMP
	BRNE PC+0x09
	LDD ZH,Y+_CORE5277_TIMER_HANDLER+0x00
	...
	ANDI TEMP,0x7f
	STD Y+_CORE5277_TIMER_CNTR,TEMP
_CORE5277_TIMER_A_IR__LF_NEXT:
	ADIW YL,0x05
	DEC LOOP_CNTR
	BRNE _CORE5277_TIMER_A_IR__LF_LOOP
.ENDIF
